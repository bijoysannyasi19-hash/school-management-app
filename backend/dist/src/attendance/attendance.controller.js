...
let AttendanceController = class AttendanceController {
    ...
    markAttendance(body) {
        return this.attendanceService.markAttendance(body.studentId, new Date(body.date), body.status, body.remarks);
    }
    ...
    getStudentAttendance(studentId, startDate, endDate) {
        return this.attendanceService.getAttendanceByStudent(studentId, new Date(startDate), new Date(endDate));
    }
...
__decorate([
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.SCHOOL_ADMIN, role_enum_1.Role.PRINCIPAL, role_enum_1.Role.TEACHER, role_enum_1.Role.CLASS_TEACHER),
